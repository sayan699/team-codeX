  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-primary">
          <div class="container">
            ...
            <a class="navbar-brand" href="#"><span class="bg-dark text-white">ViSiOn CiTy</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                <li class="nav-item active">
                  <a class="nav-link" href="#"><span class="text-white"><button class="btn btn-info">HOME</button> </span></a>
                </li>
    ...
    <div class="container bg-gradient-primary border border-danger">
<br>
<h1>SIGN UP  !...</h1>
<br>
<br>
